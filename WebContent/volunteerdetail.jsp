...
<body data-spy="scroll" data-target="#myScrollSpy" data-offset="200">
 <% 
         ...
         //   Statement statement3 = connection.createStatement() ;
            ResultSet rs1;
               rs1 = statement1.executeQuery("select * from volunteer_1 ") ; 
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ol class="breadcrumb">
                                ...
                                <li class="active">Volunteer Detail
                                </li>
                        </ol>
                    </div>
                     <div class="col-xs-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                            ...
                            <% while(rs1.next()){ %>
            <TR>
                <TD> <%= rs1.getString("f_name")+" "+rs1.getString("l_name") %></td>
                <TD> <%= rs1.getString("city") %></TD>
                <TD> <%= rs1.getString("country") %></TD>
                <TD> <%= rs1.getString("a_code")+"-"+rs1.getString("tel_num") %></TD>
