...
<body data-spy="scroll" data-target="#myScrollSpy" data-offset="200">
 <% 
            ...
            ResultSet rs1,rs2,rs3;
               rs1 = statement1.executeQuery("select * from food_distribution ") ; 
    ...
    <div class="container">
        ...
        <div id="food_distribution" class="row row-content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                            ...
                            <% while(rs1.next()){ %>
            <TR>
                <TD> <%= rs1.getString("centre") %></td>
                <TD> <%= rs1.getString("rice") %></TD>
                <TD> <%= rs1.getString("wheat") %></TD>
                <TD> <%= rs1.getString("water") %></TD>
               <TD> <%= rs1.getString("others") %></TD>
            </TR>
            <%  } %>
                    </table>
                </div>
         ...
         <div id="medicine_supplied" class="row row-content">
            <div class="col-xs-12">
                <h2>Medicine Supplied</h2>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                            <th>
                        ...
                        <% while(rs2.next()){ %>
            <TR>
                <TD> <%= rs2.getString("centre_m") %></td>
                <TD> <%= rs2.getString("pain") %></TD>
                <TD> <%= rs2.getString("anti") %></TD>
                <TD> <%= rs2.getString("bandage") %></TD>
               <TD> <%= rs2.getString("other_m") %></TD>
            </TR>
            <%  } %>
                    </table>
                </div>
        ...
        <div id="accessories" class="row row-content">
            <div class="col-xs-12">
                <h2>Accessories</h2>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                          ...
                          <% while(rs3.next()){ %>
            <TR>
                <TD> <%= rs3.getString("centre_a") %></td>
                <TD> <%= rs3.getString("cloth") %></TD>
                <TD> <%= rs3.getString("blank") %></TD>
                <TD> <%= rs3.getString("tent") %></TD>
               <TD> <%= rs3.getString("other_a") %></TD>
            </TR>
            <%  } %>
        ...
        <nav class="hidden-xs col-sm-2" id="myScrollSpy">
            <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="400">
                <li><a href="#food_distribution">Food Distribution</a></li>
                <li><a href="#medicine_supplied">Medicine Supplied</a></li>
